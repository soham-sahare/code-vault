  ...
  const [problemsList, setProblemsList] = useState<Problem[]>([
    ...
    def threeSum(self, nums: List[int]) -> List[List[int]]:
        ...
        return res`,
          ...
          notes: [
            { type: "mistake", text: "Forgetting to skip duplicates inside the while loop (while l < r and nums[l] == nums[l+1])." },
            { type: "note", text: "Sort first — this is the key insight to make two-pointer work." }
          ]
        },
        {
          name: "Two Pointers (C++)",
          lang: "C++",
          intuition: "Same two pointer logic using std::sort.",
          approach: "Use vector iteration, verify boundaries to prevent index overflow.",
          time: "O(N²)",
          space: "O(log N)",
          code: `class Solution {
public:
    vector<vector<int>> threeSum(vector<int>& nums) {
      ...
      history: [
        ...
        { stage: "Day 7 - Stage 2", date: "08-Jun-2026", status: "Pending" }
      ]
    },
    {
      num: 42,
      ...
      interval: "Recall Stage 2",
      url: "https://leetcode.com/problems/trapping-rain-water/",
      isFavorite: false,
      solutions: [
        {
          name: "Two Pointers Trap",
          lang: "Python",
          intuition: "Water at index is bounded by max heights on left and right.",
          approach: "Maintain two pointers (left, right) and leftMax, rightMax heights. Shift pointer with smaller boundary inner-wise.",
          time: "O(N)",
          space: "O(1)",
          code: `class Solution:
    def trap(self, height: List[int]) -> int:
        ...
        return water`,
          notes: [
            { type: "mistake", text: "Failing to check empty height array at input." },
            { type: "success", text: "Two-pointer beats DP solution in space: O(1) vs O(N)." }
          ]
        }
      ],
      notes: [
        "Two-pointer approach is much more space efficient than dynamic programming."
      ],
      history: [
        { stage: "Day 0 - Initial", date: "29-May-2026", status: "Done" },
        { stage: "Day 3 - Stage 1", date: "01-Jun-2026", status: "Done" }
      ]
    },
    {
      num: 1,
      ...
      solutions: [
        {
          ...
          lang: "Python",
          intuition: "Store seen values in hash table to find complement in constant time.",
          approach: "Iterate array, compute complement. Check hashmap. If exists, return indices; otherwise insert seen.",
          time: "O(N)",
          space: "O(N)",
          code: `class Solution:
    def twoSum(self, nums: List[int], target: int) -> List[int]:
        ...
        for i, num in enumerate(nums):
            ...
            seen[num] = i`,
          notes: [
            { type: "mistake", text: "Putting value index before verifying complement existence." }
          ]
        }
      ],
      notes: [
        "Classic hashmap starter."
      ],
      history: [
        { stage: "Day 0 - Initial", date: "15-May-2026", status: "Done" }
      ]
    },
    {
      num: 76,
    ...
    },
    {
      ...
      difficulty: "MED",
      diffColor: "text-amber-500 bg-amber-500/10",
      topic: "BFS, DFS, Union Find",
      status: "Due Today",
      statusColor: "text-amber-500 bg-amber-500/10 border-amber-500/20",
      interval: "Recall Stage 3",
